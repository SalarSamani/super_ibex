...
#
# Build rules for the Super SV32 MMU comprehensive test.
# Uses super_link.ld from the test directory instead of common/link.ld.

COMMON_DIR := $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))/../common
...
LINKER_SCRIPT ?= $(PROGRAM_DIR)/super_link.ld
